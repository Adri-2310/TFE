...
- **Alt 3a - Compte bloqué**: >= 5 tentatives échouées → Erreur 429 "Trop de tentatives, réessayez dans 15 minutes"
...
- **Alt B3 - Concurrent write**: Autre consultant modifie simultanément → Erreur 409 "Données modifiées, réessayez"
...
10. **[Alt B3]** Si concurrent write: Erreur 409 "Données modifiées, réessayez"
...
3. **[Alt 5]** Si erreur génération PDF: Erreur 500 "Impossible générer PDF, réessayez"
...
6. **[Alt 7]** Si service email indisponible: Erreur 503 "Email service indisponible, réessayez plus tard"
...
- **Alt 5 - Erreur PDF**: Echec génération → Erreur 500 "Impossible générer PDF, réessayez"
...
3. **[Alt 3]** Si API ONSS indisponible après 3 tentatives: Erreur 503 "API ONSS indisponible, réessayez plus tard"
...
- **Alt 3 - API ONSS DOWN**: 3 tentatives échouées → Erreur 503 "API ONSS indisponible, réessayez plus tard"
...
9. **[Alt B2]** Si concurrent write: Erreur 409 "Données modifiées, réessayez"
...
- **Alt B2 - Concurrent write**: Autre consultant modifie simultanément → Erreur 409 "Données modifiées, réessayez"
...
3. **[Alt 3]** Si state invalide: Erreur 403 "Authentification compromise, réessayez"
...
5. **[Alt 4]** Si API Exact indisponible: Erreur 503 "API Exact Online indisponible, réessayez"
...
- **Alt 4 - API Exact DOWN**: Service indisponible → Erreur 503 "API Exact indisponible, réessayez"
