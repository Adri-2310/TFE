...
Les AdminSecrétariat gèrent leurs abonnements individuels via UC-02-20 (Customer Portal par client).
...
1. **Stripe Admin Dashboard**: 
   ...
   - **NE PEUT PAS**: Voir abonnements individuels (c'est le Customer Portal pour chaque AdminSecrétariat)
2. **Email Service**:
...
- **AdminSecrétariat**: Gestion abonnement client (UC-02-20) - Customer Portal par secrétariat
